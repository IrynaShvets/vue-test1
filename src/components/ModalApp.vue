<template>
  <div class="modal-overlay" @click="$emit('close-modal')">
    <div class="modal" @click.stop>
      ...
      <form @click.prevent="postRatingToMovie" class="flex flex-col p-4 rounded bg-[#F5ECCD]">
        <textarea type="text" placeholder="Comment" v-model="comment" class="mb-2"></textarea>
...
// import { postRating} from "../services/movie.service";
// import {ref} from "vue";
...
export default {
  ...
  methods: {
    getMoviesWithLibrary() {
      //const moviesWithLibrary = JSON.parse(localStorage.getItem("movie-store"))

               console.log('модалка', this.moviesStore)
