<template>
  <div class="modal-overlay" @click="$emit('close-modal')">
    <div class="modal" @click.stop>
      <button
        class="p-2 border-0 bg-transparent absolute right-2 top-2"
      ...
      <form
        @click.prevent="handleSubmitReview"
        class="flex flex-col p-4 rounded bg-[#F5ECCD]"
      >
        <textarea
        @click.stop
          type="text"
          ...
          class="mb-2"
        ></textarea>
        <input @click.stop type="text" placeholder="Rating" v-model="mark.rating" />
