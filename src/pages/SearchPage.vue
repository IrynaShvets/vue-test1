  ...
  <container-app>
    <main>
      <div class="bg-gray-200 p-10 mb-2">
        ...
        <div class="mb-3 pt-0">
          <input type="text" v-model="query" @keypress.enter="search" placeholder="Search by title of movie"
      ...
      <ul v-if="movies" class="grid grid-cols-3 gap-5">
        <li :id="movie.id" v-for="movie in movies" :key="movie.id"
          ...
          <router-link :to="'/movie/' + movie.id">
            <img 
              :src="'https://image.tmdb.org/t/p/original' + movie.backdrop_path" @error="imageLoadOnError" alt="movie.title" loading="lazy"
...
export default {
  ...
  methods: {
    ...
    imageLoadOnError(e) {
          e.target.src = "https://i.gyazo.com/c43bcb8fc7e50c57740731c2c2e301ef.jpg"
      }
  },
};
</script>
